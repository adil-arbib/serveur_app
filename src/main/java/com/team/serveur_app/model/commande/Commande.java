package com.team.serveur_app.model.commande;
...
public class Commande {
    ...
    public Commande(int id, String date, float price, Serveur serveur, Table table, ArrayList<Plat> listPlat) {
        this.id = id;
        this.date = date;
        this.price = price;
    ...
    public Commande(String date, float price, Serveur serveur, Table table, ArrayList<Plat> listPlat) {
        this.date = date;
        this.price = price;
        this.serveur = serveur;
        this.table = table;
